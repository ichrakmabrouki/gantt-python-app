# backend/solver/model_v1.py
#
# VERSION 1 — formulation d'origine, conservee telle quelle pour la comparaison.
# Formulation de type MILP (grand M) executee dans un solveur de programmation
# par contraintes : correcte, mais O(n^2) variables booleennes de paires.
# Voir model.py pour la version 2 et benchmark_solveurs.py pour le comparatif.
